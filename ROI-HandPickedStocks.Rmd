...
gg16 <- ggplot(data=ffin, aes(x=Date, y=stockValue, group=DOW_down_median))+
        geom_line(aes(color=DOW_down_median))+
        geom_smooth(method = "lm")+
        #annotate("rect", xmin = 2018, xmax = 2019, ymin = 25, ymax = 40,
        #alpha = .2)+
        scale_y_continuous()+
        theme(legend.position="bottom")+
...
grid.arrange(gg16,gg8,gg18,ty,nrow=2)
```
