...
What stock ticker are you interested in? And what lag are you interested in? You can keep the lag from the top of this script or these defaults or change them here. You need to enter the stock name in the chunk for Rmarkdown below.
```{r}
...
```{r}
lagN <- paste('lag',lag,sep='')
cat('The number of days to retrieve the stock information is ',lag,'and the stock to look up this information for is ',stock_1)
